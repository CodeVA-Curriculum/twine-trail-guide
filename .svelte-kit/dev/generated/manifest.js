...
export const routes = [
	...
	[/^\/locations\/hosting-recordings\/?$/, [c[0], c[3], c[7]], [c[1]]],

	// src/routes/locations/making-recordings.md
	[/^\/locations\/making-recordings\/?$/, [c[0], c[3], c[8]], [c[1]]],

	// src/routes/locations/image-formatting.md
	[/^\/locations\/image-formatting\/?$/, [c[0], c[3], c[9]], [c[1]]],

	// src/routes/locations/branching-paths.md
	[/^\/locations\/branching-paths\/?$/, [c[0], c[3], c[10]], [c[1]]],

	// src/routes/locations/create-passage.md
	[/^\/locations\/create-passage\/?$/, [c[0], c[3], c[11]], [c[1]]],

	// src/routes/locations/adding-images.md
	[/^\/locations\/adding-images\/?$/, [c[0], c[3], c[12]], [c[1]]],

	// src/routes/locations/link-passages.md
	[/^\/locations\/link-passages\/?$/, [c[0], c[3], c[13]], [c[1]]],

	// src/routes/locations/start-a-story.md
	[/^\/locations\/start-a-story\/?$/, [c[0], c[3], c[14]], [c[1]]],

	// src/routes/locations/reveal-text.md
	[/^\/locations\/reveal-text\/?$/, [c[0], c[3], c[15]], [c[1]]],

	// src/routes/trails/index.svelte
	[/^\/trails\/?$/, [c[0], c[16], c[17]], [c[1]]],

	// src/routes/trails/primary-documents.md
	[/^\/trails\/primary-documents\/?$/, [c[0], c[16], c[18]], [c[1]]],

	// src/routes/trails/your-first-story.md
	[/^\/trails\/your-first-story\/?$/, [c[0], c[16], c[19]], [c[1]]],

	// src/routes/trails/oral-history.md
	[/^\/trails\/oral-history\/?$/, [c[0], c[16], c[20]], [c[1]]],
