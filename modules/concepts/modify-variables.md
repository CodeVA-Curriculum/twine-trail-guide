...
:::aside-box
This tutorial builds on the information from the *[Variable Basics](/tutorials/concepts/variable-basics)* tutorial--if you aren't sure what a variable is, consider checking that one out first!
:::
