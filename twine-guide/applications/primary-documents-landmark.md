...
2. Use [reveal links](/tutorials/applications/reveal-text) to show information about the document as the reader clicks around. Have them uncover more details as they click through different links.
3. When the reader reveals information that leads to another document, create a [link](/tutorials/concepts/link-passages) to a new passage showing the next document.
...
* **Image Problems:** Be sure to put your image link url inside `''`, and don't forget to include alt text as well! Follow the examples in the ["Adding Images"](/tutorials/applications/adding-images) tutorial if you have trouble.
